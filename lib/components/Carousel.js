...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.getInitialImage = function () {
            ...
            var images = item && _this.props.images;
            return images && _react2.default.createElement(_reactImageZoom2.default, _extends({}, _this.props.zoom, { img: images[selectedItem] }));
        };
        ...
        _this.getVariableImageHeight = function (position) {
            ...
            if (_this.state.hasMount && images.length > 0) {
                var image = _react2.default.createElement(_reactImageZoom2.default, _extends({}, _this.props.zoom, { img: images[0] }));
        ...
        for (var i = 1; i < 4; i++) {
            _this.props.images.push("http://res.cloudinary.com/at0mz/image/upload/v1523989195/man/" + i + ".jpg");
        }
        return _this;
    }
